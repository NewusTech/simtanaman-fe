...
import TabSubmission from "../components/distributor/tab-submission";
import TabManagementPlant from "../components/distributor/tab-management-plant";
import TableSubmission from "../components/distributor/table-submission";
import TableSubmissionPlant from "../components/distributor/table-submission-plant";
import TableStokPlantSeeds from "../components/distributor/table-stock-plant-seeds";
    ...
    <div>
      <div className="bg-white p-4 rounded-md shadow-md font-poppins">
        ...
        <div className="flex gap-4 justify-between items-center bg-primary-default rounded-full p-4">
          ...
          >
            <span className="text-sm">Distribusi</span>
          </button>
          <button
