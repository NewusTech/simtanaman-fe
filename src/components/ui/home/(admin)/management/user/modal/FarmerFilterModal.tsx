...
/**
 * FarmerFilterModal component renders a modal dialog with terms and conditions.
 *
 * @component
 ...
 */
const FarmerFilterModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg p-6 w-3/4 md:w-1/2 lg:w-1/3">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:gap-6">
          <FormSelect label="Kelompok Poktan" value={["Admin", "Petani"]} />
          <FormSelect
            label="Jenis Kelamin"
...
export default FarmerFilterModal;
