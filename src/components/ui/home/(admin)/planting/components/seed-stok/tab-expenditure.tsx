...
export default function TabExpenditure() {
    const [listPenambahan, setListUser] = useState([
        {
            tanggal_pengeluaran: "03/03/2025",
            ...
            <Table className="mt-4 overflow-hidden">
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="bg-gray-200 text-center">Distributor</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {listPenambahan.map((value) => (
                        <TableRow key={listPenambahan.indexOf(value)}>
                            ...
                            <TableCell className="text-center">{value.tanggal_pengeluaran}</TableCell>
