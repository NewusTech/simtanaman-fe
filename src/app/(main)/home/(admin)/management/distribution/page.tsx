...
export default function DistributorPage() {
  ...
  const handleAddAdmin = (slug: string, params?: Object) => {
    router.push("/home/management/distribution/" + slug + (params ? `?${new URLSearchParams(params as any)}` : ""));
  };
  ...
  return (
    <div className="bg-white p-4 rounded-md shadow-md font-poppins">
      ...
      <div className="mt-4 flex items-center justify-between w-full gap-4">
        ...
        <button
          onClick={() => handleAddAdmin("Tambah Distributor")}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-white shadow-md rounded-md absolute left-[-110px]">
                      <DropdownMenuItem
                        ...
                        onClick={() => handleAddAdmin("Detail Distributor", { id: value.id })}
                      >
                        Detail
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        className="cursor-pointer"
                        onClick={() => handleAddAdmin("Edit Distributor", { id: value.id })}
                      >
                        Edit
                      </DropdownMenuItem>
                      <DropdownMenuItem
