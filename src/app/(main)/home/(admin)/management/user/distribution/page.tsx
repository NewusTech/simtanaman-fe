...
/**
 * DistributionPage component renders a page for managing admin users.
 *
 * @component
 * @example
 * return (
...
export default function DistributionPage() {
  ...
  const handleAddDistributor = (value: String) => {
    router.push("/home/management/user/distribution/" + value);
  };
  ...
  return (
    <div className="bg-white p-4 rounded-md shadow-md font-poppins">
      ...
      <div className="mt-4 flex items-center justify-between w-full gap-4">
        ...
        <button
          onClick={() => handleAddDistributor("Tambah")}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-white shadow-md rounded-md absolute left-[-110px]">
                      <DropdownMenuItem
                        ...
                        onClick={() => handleAddDistributor("Detail")}
                      >
                        Detail
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        className="cursor-pointer"
                        onClick={() => handleAddDistributor("Edit")}
                      >
                        Edit
                      </DropdownMenuItem>
                    </DropdownMenuContent>
